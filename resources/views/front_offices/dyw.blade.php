...
@section('header')
    {{__('lb.front_office')}}
@endsection
@section('content')<link rel="stylesheet" href="{{asset('chosen/chosen.min.css')}}">
                ...
                @foreach($technicals as $t)
                    ...
                    <tr>
                        ...
                        <td class="text-center">   <a href="{{url('front-office/detail', $t->id)}}" title="{{__('lb.detail')}}"
                            >{{$request->code}}</a></td>
                        <td><a href="{{url('patient/detail/'.$patient->id)}}"> {{$patient->kh_first_name}} {{$patient->kh_last_name}}</a></td>
