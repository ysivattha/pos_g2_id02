...
@section('title')
    {{__('lb.create_diagnosis_template')}}
@endsection
@section('header')
    {{__('lb.create_diagnosis_template')}}
@endsection
...
<form action="{{url('diagnosis-template/save')}}" method="POST">
@csrf
    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <div class="form-group row">
                    <div class="col-sm-12">
                    <textarea name="description" id="description"  rows="3"  class="form-control ckeditor"></textarea>
                    </div>
                </div>
            </div>
        </div>
