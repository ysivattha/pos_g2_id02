...
<div class="modal fade" id="createModal" tabindex="-1" role="dialog" aria-labelledby="createModal" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <form  method="POST" id='create_form'  action="{{ route('attach_type.store') }}">
          @csrf
          <input type="hidden" name="tbl" value="hr_attach_type">
          <input type="hidden" name="per" value="hr_attach_type">
              ...
              <div class="modal-body">
                ...
                <div class="form-group row">
                    <label class="col-md-3" for="unit">
                        {{__('lb.attach_name')}} <span class="text-danger">*</span>
                    </label>
                    <div class="col-md-9">
                        <input type="text" name="attach_type_name" id="attach_type_name" class="form-control input-xs" required>
                    </div>
                </div>
