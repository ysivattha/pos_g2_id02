...
<div class="modal fade" id="createModal" tabindex="-1" role="dialog" aria-labelledby="createModal" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <form  method="POST" id='create_form'  action="{{ route('income_type.store') }}">
          @csrf
          <input type="hidden" name="tbl" value="acc_income_type">
          <input type="hidden" name="per" value="acc_income_type">
            ...
            <div class="modal-header bg-success">
              ...
              <div class="modal-body">
                ...
                <div class="form-group row">
                    <label class="col-md-3" for="in_type">
                        {{__('lb.in_type')}} <span class="text-danger">*</span>
                    </label>
                    <div class="col-md-9">
                        <input type="text" name="in_type" id="in_type" class="form-control input-xs" required>
                    </div>
                </div>
