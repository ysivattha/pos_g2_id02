...
<div class="modal fade" id="createModal" tabindex="-1" role="dialog" aria-labelledby="createModal" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <form  method="POST" id='create_form'  action="{{ route('emp_status.store') }}">
          @csrf
          <input type="hidden" name="tbl" value="hr_employee_status">
          <input type="hidden" name="per" value="hr_employee_status">
          <div class="modal-content">
            <div class="modal-header bg-success">
                <strong class="modal-title">{{__('lb.status')}}</strong>
              ...
              <div class="modal-body">
                ...
                <div class="form-group row">
                    <label class="col-md-3" for="status">
                        {{__('lb.status')}} <span class="text-danger">*</span>
                    </label>
                    <div class="col-md-9">
                        <input type="text" name="status" id="status" class="form-control input-xs" required>
                    </div>
                </div>
