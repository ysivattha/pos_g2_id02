...
<div class="modal fade" id="createModal" tabindex="-1" role="dialog" aria-labelledby="createModal" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <form  method="POST" id='create_form'  action="{{ route('attach_file.store') }}">
          @csrf
          <input type="hidden" name="tbl" value="hr_attach_file">
          <input type="hidden" name="per" value="hr_attach_file">
          <div class="modal-content">
            <div class="modal-header bg-success">
                <strong class="modal-title">{{__('lb.create_attach_type')}}</strong>
              ...
              <div class="modal-body">
                ...
                <div class="form-group row">
                    <label class="col-md-3" for="attach_type_id">
                        {{__('lb.attach_type')}} <span class="text-danger">*</span>
                    </label>
                
            
                    <div class="col-md-9">
                        <select name="attach_type_id" id="attach_type_id" class="chosen-select">
