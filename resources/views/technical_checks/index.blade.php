...
<div class="toolbox pt-1 pb-1 pl-2">
  ...
  <div class="row">
    ...
    <a href="{{route('technical.yesterday')}}">
    <button class="btn btn-success btn-xs" 
    table='request_details' permission='technical_check' token="{{csrf_token()}}">
    <i class="fa fa-calendar"></i> {{__('lb.yesterday')}}
</button>
    </a>
<a href="{{route('technical.week')}}">
<button class="btn btn-success btn-xs" 
    table='request_details' permission='technical_check' token="{{csrf_token()}}">
       ...
       <table class="table table-sm table-bordered " style="width: 100%">
            ...
            <tbody>			
                ...
                @foreach($technicals as $t)
                    ...
                    >
                        <td>{{$i++}}</td>
                        <td class="text-center">   <a href="{{url('technical/detail', $t->id)}}" title="{{__('lb.detail')}}"
                            >{{$request->code}}</a></td>
                        <td>{{$patient->code}} - {{$patient->kh_first_name}} {{$patient->kh_last_name}}</td>
                      ...
                      <td>  
                        ...
                        @endif</td>
                        <td>
                        <a href="{{url('technical/print/'.$t->id)}}" target="_blank" class="btn btn-primary btn-xs">
