...
@section('modal')
    <div class="modal fade " id="createModal" tabindex="-1" role="dialog" aria-labelledby="createModal" aria-hidden="true">
        ...
        <form method="POST" id='create_form'  action="{{ route('training_course.store') }}" >
            ...
            <input type="hidden" name="tbl" value="hr_training_course">
            <input type="hidden" name="per" value="hr_training_course">
                                  ...
                                  <div class="form-group mb-2">
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <label  for="course_name">
                                            {{__('lb.course_name')}}  <span class="text-danger">*</span>
                                        </label>


                                        <input type="text" name="course_name" class="form-control input-xs" required>
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <label  for="peroid">
                                            {{__('lb.peroid')}}  <span class="text-danger">*</span>
                                        </label>


                                        <input type="text" name="peroid" class="form-control input-xs" required>
