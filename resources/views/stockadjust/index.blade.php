...
<div class="modal fade" id="createModal" tabindex="-1" role="dialog" aria-labelledby="createModal" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <form  method="POST" id='create_form'  action="{{ route('adjust.store') }}">
          @csrf
          <input type="hidden" name="tbl" value="sto_stock_adjust">
          <input type="hidden" name="per" value="sto_stock_adjust">
          <div class="modal-content">
            <div class="modal-header bg-success">
                <strong class="modal-title">{{__('lb.Adjust')}}</strong>
              ...
              <div class="modal-body">
                ...
                <div class="form-group row">
                    <label class="col-md-3" for="qty_rest">
                        {{__('lb.qty_rest')}}
                    </label>
                    <div class="col-md-9">
                        <input type="number" min="0" step="any" name="qty_rest" id="qty_rest" class="form-control input-xs" >
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <label class="col-md-3" for="qty_over">
                        {{__('lb.qty_over')}} <span class="text-danger">*</span>
                    </label>
                    <div class="col-md-9">
                        <input type="number" min="0" step="any" name="qty_over" id="qty_over" class="form-control input-xs" >
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input type="note" name="date" id="date" class="form-control input-xs" >
                    </div>
                </div>
    ...
    $.ajax({
         ...
         success: function(sms){
            ...
            if(sms>0)
            {
                ...
                $('#sms').html(txt);
                $("#create_form")[0].reset();
                $('#stock_adjust_table').DataTable().ajax.reload();
