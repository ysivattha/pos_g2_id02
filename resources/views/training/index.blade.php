...
@section('modal')
    <div class="modal fade " id="createModal" tabindex="-1" role="dialog" aria-labelledby="createModal" aria-hidden="true">
        ...
        <form method="POST" id='create_form'  action="{{ route('training_course.store') }}" >
            @csrf

            <input type="hidden" name="tbl" value="hr_training">
            <input type="hidden" name="per" value="hr_training">
            <div class="modal-content">
                <div class="modal-header bg-success">
                    <strong class="modal-title"> {{ __('lb.create_training') }}</strong>
                        ...
                        <div class="col-sm-12">
                                  ...
                                  <div class="form-group mb-2">
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <label  for="course_id">
                                            {{__('lb.course')}}  <span class="text-danger">*</span>
                                        </label>


                                        <select name="course_id" id="course_id" class="chosen-select">
                                            <option value="">{{__('lb.select_one')}}</option>
                                            <option value="1">123</option>
                                            {{-- @foreach($suppliers as $sup)
                                            <option value="{{ $sup->id }}">{{ $sup->contact_name }}</option>
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="number" name="score" min="0" step="any" class="form-control input-xs" required>
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <label  for="result_id">
                                            {{__('lb.result')}}  <span class="text-danger">*</span>
                                        </label>


                                        <select name="result_id" id="result_id" class="chosen-select">
                                            <option value="">{{__('lb.select_one')}}</option>
                                            <option value="1">123</option>
                                            {{-- @foreach($suppliers as $sup)
                                            <option value="{{ $sup->id }}">{{ $sup->contact_name }}</option>
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text" name="note"  class="form-control input-xs" >
                        ...
                        {{-- <div class="col-sm-6">
                            ...
                            <div class="form-group mb-2">
                                    ...
                                    <label  for="generation">
                                        ...
                                        <input type="text"  name="generation" id="generation" class="form-control input-xs" required>
                            ...
                            <div class="form-group mb-2">
                                ...
                                <label  for="trainer_name">
                                    ...
                                    <input type="text"  name="trainer_name" id="trainer_name" class="form-control input-xs" >
                            ...
                            <div class="form-group mb-2">
                                ...
                                <label  for="pdf_flie">
                                    ...
                                    <input type="text"  name="pdf_flie" id="pdf_flie" class="form-control input-xs" >
